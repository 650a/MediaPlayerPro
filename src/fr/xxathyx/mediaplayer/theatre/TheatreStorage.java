...
public class TheatreStorage {
    ...
    public Map<UUID, TheatreRoom> loadRooms() {
        ...
        try {
            ...
            plugin.getLogger().warning("[MediaPlayer:Theatre]: Failed to load rooms.yml: " + e.getMessage());
            return rooms;
        }
    ...
    public void saveRooms(Iterable<TheatreRoom> rooms) {
        ...
        try {
            ...
            plugin.getLogger().warning("[MediaPlayer:Theatre]: Failed to save rooms.yml: " + e.getMessage());
        }
    }
    ...
    public Map<UUID, List<ShowScheduleEntry>> loadSchedules() {
        ...
        try {
            ...
            plugin.getLogger().warning("[MediaPlayer:Theatre]: Failed to load schedules.yml: " + e.getMessage());
            return schedules;
        }
        ConfigurationSection roomsSection = config.getConfigurationSection("rooms");
        if (roomsSection == null) {
    ...
    public void saveSchedules(Map<UUID, List<ShowScheduleEntry>> schedules) {
        ...
        try {
            ...
            plugin.getLogger().warning("[MediaPlayer:Theatre]: Failed to save schedules.yml: " + e.getMessage());
        }
    }
